...
import (
	...
	transport "github.com/craftgodotdev/craftgo/tests/e2e/matrix/internal/transport/tenant-service"
	"github.com/craftgodotdev/craftgo/tests/e2e/matrix/svccontext"
)

// RegisterRoutes wires every TenantService endpoint onto srv. Patterns
