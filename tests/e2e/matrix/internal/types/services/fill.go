...
func (v *AcctCreateUserReq) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
...
// no map: a copy holding the changed values takes the map's place. Past fillDepth values deep
// it stops at once, reporting stopped.
func (v *AcctUpdateUserReq) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
...
// no map: a copy holding the changed values takes the map's place. Past fillDepth values deep
// it stops at once, reporting stopped.
func (v *AcctUser) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
...
// no map: a copy holding the changed values takes the map's place. Past fillDepth values deep
// it stops at once, reporting stopped.
func (v *InventoryListResp) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
...
// no map: a copy holding the changed values takes the map's place. Past fillDepth values deep
// it stops at once, reporting stopped.
func (v *ListUsersResp) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
...
// no map: a copy holding the changed values takes the map's place. Past fillDepth values deep
// it stops at once, reporting stopped.
func (v *PaginatedResp) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
...
// no map: a copy holding the changed values takes the map's place. Past fillDepth values deep
// it stops at once, reporting stopped.
func (v *ProjectsResp) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
...
// no map: a copy holding the changed values takes the map's place. Past fillDepth values deep
// it stops at once, reporting stopped.
func (v *ReportCards) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
...
// no map: a copy holding the changed values takes the map's place. Past fillDepth values deep
// it stops at once, reporting stopped.
func (v *AcctValidationFailedBody) FillEmpty(depth int) (changed, stopped bool) {
	if v == nil {
		return false, false
	}
	if depth > fillDepth {
