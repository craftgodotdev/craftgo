module github.com/craftgodotdev/craftgo/example/taskflow
...
require go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.71.0 // indirect
