...
// replaced by the logger it writes through at the call. A logger that writes through a Follow
// logger, as a wrapper around one does, cannot be the default: its lines would come back to it.
