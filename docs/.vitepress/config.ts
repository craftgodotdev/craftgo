...
export default defineConfig({
  title: 'craftgo',
  description: 'Design-first Go framework on net/http. Spec your API, generate everything.',
  cleanUrls: true,
  lastUpdated: true,
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'AI Reference', link: '/llms' },
      {
        text: 'v0.x',
        items: [
          { text: 'Changelog', link: 'https://github.com/dropship-dev/craftgo/blob/main/CHANGELOG.md' },
          { text: 'Releases', link: 'https://github.com/dropship-dev/craftgo/releases' },
        ],
      },
    ],
      ...
      '/reference/': [
        {
          ...
          items: [
            ...
            { text: 'Decorator Registry', link: '/reference/decorator-registry' },
      ...
      '/tutorials/': [
        {
          text: 'Tutorials',
          items: [
            { text: 'TODO API', link: '/tutorials/todo-api' },
          ],
        },
      ],
    },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/dropship-dev/craftgo' },
    ],
    ...
    editLink: {
      pattern: 'https://github.com/dropship-dev/craftgo/edit/main/docs/:path',
