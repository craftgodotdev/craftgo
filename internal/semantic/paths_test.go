...
func TestRoutePatternsNetHTTPRefusesRejected(t *testing.T) {
	cases := []struct {
		...
		{"method dot-dot segment", "", `service S { get A /a/../b {} }`, CodeRoutePattern},
		{"method dot segment", "", `service S { get A /files/. {} }`, CodeRoutePattern},
		{"method dotted segments", "", `service S { get A /.well-known/v1.0/keys.json {} }`, ""},
